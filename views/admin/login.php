            ...
            <div class="content-wrapper d-flex align-items-center auth">
                <div class="row flex-grow">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5"> <?php
                    if (!empty($error))
                    {
                ...
                ?> <div class="brand-logo">
                            ...
                            <form class="pt-3" method="POST" action="<?= URL; ?>admin/login">
                                <div class="form-group">
                                    <input type="email" value="admin@gmail.com" class="form-control form-control-lg"
                                        name="email" id="email" placeholder="Username">
                                </div>
                                <div class="form-group">
                                    <input type="password" value="admin" class="form-control form-control-lg"
                                ...
                                <div class="mt-3">
                                    <button type="submit"
                                        ...
                                        IN </button>
                                    <br>
                                    <p>Email = admin@gmail.com<br> Pass&nbsp; = &nbsp;admin</p>
                                </div>
                            </form>
                        </div>
                    </div>
